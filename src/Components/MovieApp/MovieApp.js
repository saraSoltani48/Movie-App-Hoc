...
import ListMovie from "../Card-list/list-Movie";
import Rating from "../Rating/Rating";
import Search from "../Search/search";
import Hocloding from "../HocLoading/Hocloding";
  ...
  render() {
    return (
      <div className="App">
        ...
        />
   <Hocloding  loading={this.loading} />
        
        
        <ListMovie
        
        
          tableMovie={this.state.Mytab.filter(el=>el.name.toLowerCase()
